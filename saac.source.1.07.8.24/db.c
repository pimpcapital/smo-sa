...
/*
  DB及云云五今互凶日氏仁卅勻凶日歹曰丐化卅雲允〔中引及扔奶術及2  卞允月
  0分勻凶日1卞允月
 */
static int
reallocDB( void )
...
/*
  ...
  贗濠卅午仇欠卞 Insert 允月〔切中今中  井日云云五中  卞卅日氏匹中月午
  移爛
    ...
    for(i=0;i<MAXTABLE;i++){
        if( dbt[i].use == 0 ){
            ...
            */
            ...
            /* 玄永皿及用□玉毛賡渝祭允月卅曰〔
               儂  及樺寧手幫醒及樺寧手雲卅元匹方中〔
             0x7fffffff午中丹襖反｝  儂  及樺寧反今幻升啦  毛手凶卅中及分〔*/
...
{
#define MAXHITS 1024        /* 贗癲支卅丐〔匹手仇木匹蝸坌日仄中冗 ringo */
