...
void lssproto_JB_recv( int fd,int x,int y )
{
	...
	|| floor == 130	
	|| getwatcallmap()
	|| floor == getwatchmap(0) || floor == getwatchmap(1) || floor == getwatchmap(2) 
	|| floor == getwatchmap(3) || floor == getwatchmap(4)){
