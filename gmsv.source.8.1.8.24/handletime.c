...
/*
  LSTIME_SECONDS_PER_DAY 毛  尹月午｝凜棉及褡心填寧毛  尹月仇午互匹五月〔
...
/* 仇仇引匹匹｝域  互銨引勻化井日窒  凶勻凶井〔 */
        * LSTIME_HOURS_PER_DAY / LSTIME_SECONDS_PER_DAY;
    /* 域  丐凶曰及  醒匹喃勻化井日域  丐凶曰及凜棉醒毛井仃月午蜇箕窒凜
     卅及井互歹井月〔*/
