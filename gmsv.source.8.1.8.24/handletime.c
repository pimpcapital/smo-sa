...
#define LSTIME_SECONDS_PER_DAY 5400 /* LSTIME°ì  ¤Ö¤ó¤Î¸½  ¤Î  ¿ô */

/*
  LSTIME_SECONDS_PER_DAY ¤ò  ¤¨¤ë¤È¡b»þ´Ö¤Î¿Ê¤ß¶ñ¹ç¤ò  ¤¨¤ë¤³¤È¤¬¤Ç¤­¤ë¡e

  ÃÍ            LS»þ´Ö¤Ç°ì  ¤¢¤¿¤ê¤Î¸½  ¤Î»þ´Ö¿ô
  9000 (  ½à)   2.5 [hour]
...
#define LSTIME_HOURS_PER_DAY 1024 /* LSTIME°ì  ¤Ö¤ó¤ÎLSTIME¤Î»þ´Ö¿ô */
#define LSTIME_DAYS_PER_YEAR 100 /* LSTIME°ì  ¤Ö¤ó¤ÎLSTIME¤Î  ¿ô */
...
/*------------------------------------------------------------
 * °ì¥ë¡¼¥×¤Ë°ì²ó¸Æ¤Ð¤ì¤Æ¡b»þ´Ö¤ò¿Ê¤á¤ë¡e
 * °ú¿ô
 *  ¤Ê¤·
 * ÊÖ¤êÃÍ
 *  ©¨      TRUE(1)
...
/*******************************************************************
º£¸µÃ¶¤Ë¤·¤¿¡ebyHiO 1998/12/4 18:37
*******************************************************************/
static long era = (long)912766409 + 5400; 
									/* SA¤Î°Ù¤Ë¤º¤é¤·¤¿ */
									/* LS¸µ  ¤òÄêµÁ¤¹¤ë¤Æ¤­¤È¡¼¤Ê¿ôÃÍ¡e
                                    ¥¯¥é¥¤¥¢¥ó¥È¤È  ¤¸¤¸¤ã¤Ê¤¤¤È¤À¤á¡e*/

/*******************************************************************
	¥Þ¼³¥ó»þ´Ö¤«¤éLS»þ´Ö¤Ë¤¹¤ë
	long t : time¤Ç½Ð¤ë
	LSTIME *lstime : LSTIME¹½Â¤  ¤Ø¤Î¥Ý¥¤¥ó¥¿
*******************************************************************/
void RealTimeToLSTime(long t , LSTIME *lstime)
{
	long lsseconds = t - era; /* LS¸µ  ¤«¤é¤Î  ¿ô */
    long lsdays; /* LS¸µ  ¤«¤é¤Î  ¿ô */

    /* ¸µ  ¤«¤é¤Î  ¿ô¤ò1  Åö¤ê¤Î  ¿ô¤Ç³ä¤ë¤È¡b  ¤Ë¤Ê¤ë */
	lstime->year = (int)( lsseconds/(LSTIME_SECONDS_PER_DAY*LSTIME_DAYS_PER_YEAR) );

    lsdays = lsseconds/LSTIME_SECONDS_PER_DAY;/* ¤Þ¤º¸µ  ¤«¤é¤Î  ¿ô¤ò·×»»¤·¤Æ */
	lstime->day  = lsdays % LSTIME_DAYS_PER_YEAR;/*   Åö¤¿¤ê¤Î  ¿ô¤Ç³ä¤Ã¤¿¤¢¤Þ¤ê¤¬  */


    /*(450*12)  ¤Ç1  */
    lstime->hour = (int)(lsseconds % LSTIME_SECONDS_PER_DAY )
/* ¤³¤³¤Þ¤Ç¤Ç¡b°ì  ¤¬»Ï¤Þ¤Ã¤Æ¤«¤é²¿  ¤¿¤Ã¤¿¤«¡e */
        * LSTIME_HOURS_PER_DAY / LSTIME_SECONDS_PER_DAY;
    /* °ì  ¤¢¤¿¤ê¤Î  ¿ô¤Ç³ä¤Ã¤Æ¤«¤é°ì  ¤¢¤¿¤ê¤Î»þ´Ö¿ô¤ò¤«¤±¤ë¤È¸½ºß²¿»þ
     ¤Ê¤Î¤«¤¬¤ï¤«¤ë¡e*/
...
{
	*t=(long)(
        ( lstime->hour*LSTIME_DAYS_PER_YEAR+lstime->day) /* »þ´Ö */
               *LSTIME_HOURS_PER_DAY

        +     lstime->year)
        /*¤³¤Î´Ø¿ô¤Ï¤Ð¤°¤Ã¤Æ¤¤¤ë¤è¤¦¤Ë¸«¤¨¤ë¡enakamura      */
...
/*******************************************************************
	LS»þ´Ö¤Çº£¤Î»þ´Ö¶èÊ¬¤ò  ¤ë
	  ¤êÃÍ int :   0¡bÄ«1¡bÃë2¡b  3
	LSTIME *lstime : LSTIME¹½Â¤  ¤Ø¤Î¥Ý¥¤¥ó¥¿
*******************************************************************/
