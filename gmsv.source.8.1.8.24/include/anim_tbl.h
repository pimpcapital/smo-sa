...
//#define SPRSTART			30000		// SPR犯□正及銨引曰及  寞
...
#define SPR_mail			100507		//	丟□伙邋耨失瓦丟□撲亦件
//躲絆失瓦丟
...
#define CG_PET_WND_MAIL_BTN		26055	// 矢永玄丟□伙示正件
...
#define CG_BTL_ITEM_WND_TITLE			26072	// 爵  凜及失奶  丞它奴件玉它正奶玄伙

// 旦  □正旦它奴件玉它
#define CG_STATUS_WND					26073	// 皿伊奶乩□旦  □正旦它奴件玉它
#define CG_STATUS_WND_VICTORY_MARK		26074	//     穴□弁
#define CG_STATUS_WND_LV_UP_POINT		26075	// 伊矛伙失永皿  儂
...
// 丟□伙它奴件玉它
#define CG_MAIL_WND						26082	// 丟□伙它奴件玉它
#define CG_MAIL_WND_SEND_WND			26200	// 丟□伙霜耨它奴件玉它
#define CG_MAIL_WND_PET_SEND_WND		26201	// 丟□伙午矢永玄霜耨它奴件玉它
#define CG_MAIL_WND_ITEM_BTN			26202	// 失奶  丞示正件
#define CG_MAIL_WND_HISTORY_WND			26203	// 丟□伙    它奴件玉它

//#define CG_MAIL_WND_MAIL_BTN			26083	// 丟□伙示正件
...
#define CG_FIELD_GROUP_BTN_OFF			26105	// 弘伙□皿示正件左白橇謫
#define CG_FIELD_GROUP_BTN_ON			26106	// 弘伙□皿示正件左件橇謫
#define CG_FIELD_MAIL_LAMP				26107	// 丟□伙熬耨仿件皿
...
#define CG_CHR_MAKE_HOME_NAME0	29040		// 請褥嘩  ＞扔丞幼伙及翹＝
#define CG_CHR_MAKE_HOME_NAME1	29041		// 請褥嘩  ＞穴伉瓜旦及翹＝
#define CG_CHR_MAKE_HOME_NAME2	29042		// 請褥嘩  ＞斥乓斥乓及翹＝
#define CG_CHR_MAKE_HOME_NAME3	29043		// 請褥嘩  ＞市伙正□瓜及翹＝
