...
typedef enum
{
    ...
    E_T_WINDAT,
    E_T_POISON,               /*   ¬¤¤¯¤¿¤Ó¤Ë¥À¥á¡¼¥¸          */
    E_T_PARALYSIS,            /* ¤·¤Ó¤ì¡b1  ¤Î¹Ô  ¤¬¤Ç¤­¤Ê¤¤¡e */
    E_T_SLEEP,                /* Ì²¤ê¡e¹Ô  ¤Ç¤­¤Ê¤¤            */
    E_T_STONE,                /* ÀÐ¡e¹Ô  ¤Ç¤­¤Ê¤¤              */
    E_T_DRUNK,                /* ¿ì¤¦¡e      ¤¬²¼¤¬¤ë     */
    E_T_CONFUSION,            /* º®Íð¡e  ·â    ¤ò¸í¤ë     */
    E_T_PETSKILL1,
    E_T_PETSKILL2,
    E_T_PETSKILL3,
    E_T_PETSKILL4,
...
{
    GROUP_ID,
	GROUP_APPEARBYITEMID,		/* ¤³¤Î¥¢¥¤  ¥à¤ò  ¤Ã¤Æ¤¤¤¿¤é½Ð¸½¤¹¤ë -1 ¤Ï  »ë*/
	GROUP_NOTAPPEARBYITEMID,	/* ¤³¤Î¥¢¥¤  ¥à¤ò  ¤Ã¤Æ¤¤¤¿¤é½Ð¸½¤·¤Ê¤¤ -1 ¤Ï  »ë*/
    ENEMY_ID1,
    ENEMY_ID2,
    ENEMY_ID3,
    ENEMY_ID4,
