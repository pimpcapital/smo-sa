...
#define BCF_FALL		(1 << 14)	//落馬術
#ifdef _SKILL_TOOTH
#define BCF_TOOTH		(1 << 15)	//  齒
#endif
#ifdef _PSKILL_MODIFY
#define BCF_ATTDOUBLE	(1 << 16)	//屬性強化
#endif
#ifdef _SKILL_ROAR  
#define BCF_ROAR		(1 << 17)	//寵技:大吼(克年獸)
#endif 
...
#define BCF_F_SKILLACT	(1 << 22)	//擊中前秀圖
#define	BCF_TRAP		(1 << 25)	//陷阱
#define BCF_NO_DAMAGE   (1 << 26)   //雙重攻擊
#endif
#define BCF_B_SKILLACT	(1 << 23)	//擊中後秀圖



#ifdef _EQUIT_ARRANGE
#define BCF_B_ARRANGE	(1 << 24)	//格擋秀圖
#endif
...
enum{
	...
	BATTLE_ST_STONE,	 //  4 "石",
	BATTLE_ST_DRUNK,	 //  5 "醉",
	BATTLE_ST_CONFUSION, //  6 "亂",
    BATTLE_ST_WEAKEN,    //  7 "虛"
	BATTLE_ST_DEEPPOISON,//  8 "劇毒"
...
#endif
#ifdef _PROFESSION_SKILL			// WON ADD 人物職業技能
	BATTLE_ST_DIZZY,	 // 12 "暈"
	BATTLE_ST_ENTWINE,	 // 13 "纏"
	BATTLE_ST_DRAGNET,	 // 14 "天羅地網"
	BATTLE_ST_ICECRACK,  // 15 "冰爆術"
	BATTLE_ST_OBLIVION,	 // 16 "遺忘"
	BATTLE_ST_ICEARROW,	 // 17 "冰箭"
	BATTLE_ST_BLOODWORMS,// 18 "嗜血蠱"
	BATTLE_ST_SIGN,		 // 19 "一針見血"
	BATTLE_ST_INSTIGATE, // 20 "挑撥"
	BATTLE_ST_F_ENCLOSE, // 21 "火附體"
	BATTLE_ST_I_ENCLOSE, // 22 "冰附體"
	BATTLE_ST_T_ENCLOSE, // 23 "雷附體"
	BATTLE_ST_FOCUS,	 // 24 "專注戰鬥"	
    ...
    //BATTLE_ST_BOUNDARY_F, //32 "火結界
	BATTLE_ST_WATER, //32 "水附體"
	BATTLE_ST_WORKANNEX, //33 "附身"
	BATTLE_ST_FEAR, //34 "恐懼"
	BATTLE_ST_ICECRACK2,  // 35 "冰爆術"
...
enum{
	...
	BATTLE_MD_TRAP,
#ifdef _PETSKILL_ACUPUNCTURE
    BATTLE_MD_ACUPUNCTURE, //針刺外皮
#endif
	BATTLE_MD_END 
};

#ifdef _PETSKILL_RETRACE
    //存放BATTLE_Attack函式執行後的攻擊模式   
...
int CHAR_BattleStayLoop( int charaindex);//原地遇敵
#endif
