...
#define _JZ_VIPCODE								//吉仔 ADD VIP代碼
//#define _DEBUG_JZ								//吉仔 ADD 只用於調試-其他情況請關閉
#ifdef _DEBUG_JZ
	#define SERVER_VERSION "SMO v8.1.8.24 For Linux Debug Marking By 吉仔"
#else
	#ifdef _JZ_VIPCODE
		#ifdef _LONGZORO_MAKE
			#define SERVER_VERSION "SMO v8.1.8.24 For Linux VIP By 吉仔"
		#else
			#define SERVER_VERSION "SMO v8.1.8.24 For Linux VIP-支持龍zoro登陸器 By 吉仔"
		#endif
	#else
		#define SERVER_VERSION "SMO v8.1.8.24 For Linux PUB By 吉仔"
	#endif
#endif
...
//#define _RUNNING_KEY  "11111111"	// (可開放)( 石器 6.0 )
	...
	#define _RUNNING_KEY  "20070328"	// (可開放)( 石器 6.0 )
#endif
...
//#define _TEST_PETFUSIONTIME		// (不可開) ANDY 測試寵物融合  食時間加快
/* -------------------------------------------------------------------
...
#define _ITEM_S_TEMP						//吉仔 8.0道具封包支持，此功能為臨時功能
#endif
...
#define _JZ_CF_DELPETITEM				//吉仔 ADD CF定義登陸時刪除指定寵物和物品
	...
	//開放人物突破6轉功能必須開放人物6轉
	#define _JZ_TRANSX	7					//(可開) 吉仔 ADD 人物突破6轉(不可直接改)
...
#define _JZ_MEMREDUCE						//吉仔 ADD 內存節省項目
#define _JZ_BEST								//吉仔 ADD 優化封包處理-場景管理
//#define _JZ_EPOLL								//吉仔 ADD EPOLL模型
///測試項目
