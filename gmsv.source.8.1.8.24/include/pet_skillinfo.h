...
#define PETSKILL_WILDVIOLENTATTACK ( 540)//¨g¼É vincent add 2002/05/16
#endif
#ifdef _SKILL_SPEEDY_ATT
#define PETSKILL_SPEEDYATTACK ( 541)     //¯e³t vincent add 2002/05/16
#endif
#ifdef _SKILL_GUARDBREAK2
#define PETSKILL_GUARDBREAK2 ( 542)      //¯}°£¨¾¿m2 vincent add 2002/05/20
#endif
#ifdef _SKILL_SACRIFICE
#define PETSKILL_SACRIFICE ( 543)		 //±Ï´© vincent add 2002/05/30
#endif

#ifdef _SKILL_WEAKEN 
#define PETSKILL_WEAKEN ( 544)           //µê®z vincent add 2002/07/11
#endif

#ifdef _SKILL_DEEPPOISON  
#define PETSKILL_DEEPPOISON ( 545)       //¼@¬r vincent add 2002/07/16
#endif

#ifdef _SKILL_BARRIER  
#define PETSKILL_BARRIER ( 546)          //Å]»Ù vincent add 2002/07/16
#endif

#ifdef _SKILL_NOCAST 
#define PETSKILL_NOCAST ( 547)           //¨IÀq vincent add 2002/07/16
#endif


#ifdef _SKILL_ROAR 
#define PETSKILL_ROAR ( 548)             //¤j§q vincent add 2002/07/11
#endif
