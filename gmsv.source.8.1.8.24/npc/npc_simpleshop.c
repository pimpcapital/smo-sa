 ...
 *
 * NPCARGUMENT卞俜  仄凶失奶  丞毛  蜃卞赭  仄化中月雲饕〔
 *     SIMPLESHOP_MAXINFINITITEM潘    蜃卞戲岳允月仇午互匹五月〔
 *   蜃戲岳失奶  丞午  元潘  及失奶  丞毛  勻凶日  勻凶支勾互
 * 壑釵井日壅  允月〔
 * 引凶｝皿伊奶乩□井日手及毛  中午月仇午互匹五月互｝丐月襖蟾
 * (NPC_SIMPLESHOPMAXBUYPRICE)方曰嫖中嗯毛障  歹卅仁化反中仃
 * 卅中  潸反匹五卅中〔  中午勻凶失奶  丞反公及樺匹卅仁卅月〔
 * 引凶｝失奶  丞及澀爛匹cost互澀爛今木化中卅中手及手  中午木卅中〔
 * 2諦動曉及皿伊奶乩□互饕卞五凶午五反｝  及菸毛穸燮允月〔公丹允月
...
/*
 * 饕互用□穴伙它奶件玉它毛請允〔它奶件玉它及廿凶氏毛瓷允午｝
 *   賡卞饕卞  仄井仃凶午五午  元橇謫卞手升月〔
 * int meindex : 饕及index
...
/*
 * 丐月平乓仿奶件犯弁旦及平乓仿卞｝雲心六window毛釩仁凶戶及
 * 樹  毛芨尹月〔
...
/*
 * 饕互  蜃卞  勻化中月失奶  丞毛  凶六月〔賡渝祭凜午潸曰婁五及  
 * 卞裟少〔
 */
static BOOL NPC_SimpleShopFillItem( int meindex, char *npcarg )
{
 ...
 * npcarg及中勻仇戶及玄□弁件卞
 * 仇氏卞切反,仍戶氏仁分今中,仁分今中卅
 * 及方丹卞俜  今木凶  儂  毛手午卞  爛允月〔仇及午五及犯伉立正反","〔
 *
 * 婁醒
 * msg:皿伊奶乩□互仄扎屯勻凶  儂  
