...
typedef struct tagFunctionNameSet
{
    ...
    char*   windowtalkedfunc;							//玩家按下對話按鈕時觸發
}FunctionNameSet;
 ...
 * 婁醒
 *  filename   char*       澀爛白央奶伙毛  心銨戶月玄永皿犯奴伊弁玄伉
 * 忒曰襖
 *  岳      TRUE(1)
 *  分戶(仇木動曉白央奶伙毛  氏匹反中仃卅中)
 *  撩      FALSE(0)
 ------------------------------------------------------------*/
