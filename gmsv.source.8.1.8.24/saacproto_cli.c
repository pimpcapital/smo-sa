...
612 : 	 中切中切  儂  由□旦及伙□民件毛踏井卅仁化手中中方丹卞〔
613 : 	 <dl>
614 : 	   <dt>string id
615 : 	   <dd>user ID
...
600 : 		   及賺匹丐曰｝公木互蜊醒坌 "|" 匹勾卅互月〔蜊醒互0及樺寧反
601 : 		   塢  儂  〔
602 : 	   <dt>int num
...
*/
...
#ifdef _RECAL_ASK_PLAYER			// WON 要求人物資料
	if( strcmp( funcname, "ACRecalPlayer") == 0){		// 線上人物資料
	...
	if( strcmp( funcname, "ACRecalBackupPlayer") == 0){		// 備份人物資料
		char *uid, *id, *char_data;
		int userfdid, char_num, date, GmCliId;
	...
	if( strcmp( funcname, "ACRecalBackupDate") == 0){		// 備份日期
		char *uid, *id, *char_data;
		int userfdid, char_num, date, GmCliId;
